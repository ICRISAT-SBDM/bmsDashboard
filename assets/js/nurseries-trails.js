...
// Create map instance
chart = am4core.create("nurseries-trails", am4maps.MapChart);
...
function updateCustomMarkers( event ) {
  ...
  imageSeries.mapImages.each(function(image) {
    ...
    image.dummyData.externalElement.onclick = () => {
    	...
    	$('#tooltipContent').css({'left': (xy.x - 75) + 'px', 'top': (xy.y + 80) + 'px', 'display': 'block'});
			                    ...
			                    <div class="profile-card-with-cover-content text-center">
			                        <div class="profile-details mt-1">
			                            ...
			                            <ul class="list-inline clearfix mt-1">
			                                ...
			                                <li><h4 class="block">Trails</h4> ${fieldData.trails}</li>
			                            </ul>
			                        </div>
			                    </div>
			                </div>
